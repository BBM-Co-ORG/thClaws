...
impl ShellRegistry {
    ...
    fn builtin_only_map() -> HashMap<String, EmbeddedShell> {
        ...
        for shell in [session_explorer(), chatbot(), media_studio(), team_control()] {
...
fn team_control() -> EmbeddedShell {
    build_embedded_shell(
        ...
        &[
            ("index.html", include_bytes!("../../assets/gui-shells/team-control/index.html"), "text/html; charset=utf-8"),
            ("main.js", include_bytes!("../../assets/gui-shells/team-control/main.js"), "application/javascript; charset=utf-8"),
            ("style.css", include_bytes!("../../assets/gui-shells/team-control/style.css"), "text/css; charset=utf-8"),
            ("icon.svg", include_bytes!("../../assets/gui-shells/team-control/icon.svg"), "image/svg+xml"),
        ],
        "team-control",
    )
}
